        ...
        Column
        {
            ...
            RowLayout
            {
                ...
                Qaterial.ColorIcon
                {
                    ...
                    source:  expanded? "qrc:/assets/images/qaterial/chevron-up.svg" : "qrc:/assets/images/qaterial/chevron-down.svg"
                    iconSize: 14
                }
                Item
                {
            ...
            RowLayout {
                ...
                DefaultButton {
                    ...
                    iconColor: DexTheme.warningColor
                    text: qsTr("Cancel")
                ...
                DefaultButton {
                    ...
                    Layout.fillHeight: true
                    iconSource: "qrc:/assets/images/qaterial/eye-outline.svg"
                    text: qsTr("Show")
                    onClicked: {
                        order_modal.open()
