        ...
        Column // Header
        {
            ...
            DexLabel // Description
            {
                ...
                DexIconButton
                {
                    ...
                    icon: _subHistoryRoot.displayFilter ? "qrc:/assets/images/qaterial/close.svg" : "qrc:/assets/images/qaterial/filter.svg"
                    iconSize: 14
        ...
        Item
        {
            ...
            Item
            {
                ...
                DefaultComboBox
                {
                    ...
                    onCurrentIndexChanged: API.app.orders_mdl.limit_nb_elements = options[currentIndex]
                }
                DefaultButton {
                    anchors.verticalCenter: parent.verticalCenter
                    anchors.right: parent.right
