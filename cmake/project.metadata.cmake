...
macro(generate_macos_metafiles)
    ...
    ## The ci_tools_atomic_dex installer tree is not shipped in all source
    ## distributions; only configure installer files when the templates exist.
    if (EXISTS ${CMAKE_SOURCE_DIR}/ci_tools_atomic_dex/installer/osx/config/config.xml.in)
    ...
    if (EXISTS ${CMAKE_SOURCE_DIR}/ci_tools_atomic_dex/installer/osx/packages/com.komodoplatform.atomicdex/meta/package.xml.in)
    ...
    if (EXISTS ${CMAKE_SOURCE_DIR}/ci_tools_atomic_dex/installer/osx/packages/com.komodoplatform.atomicdex/meta/installscript.qs.in)
