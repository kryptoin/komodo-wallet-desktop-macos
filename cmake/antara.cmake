...
macro(init_apple_env)
    if (NOT ${CMAKE_CXX_COMPILER_ID} MATCHES "AppleClang")
        ...
        if (APPLE)
            ...
            ## Apple Silicon (Homebrew /opt/homebrew) LLVM locations
            if (EXISTS "/opt/homebrew/opt/llvm/lib")
                link_directories("/opt/homebrew/opt/llvm/lib")
            endif ()
            if (EXISTS "/opt/homebrew/opt/llvm@8/lib")
                link_directories("/opt/homebrew/opt/llvm@8/lib")
            endif ()
            if (EXISTS "/opt/homebrew/opt/llvm@9/lib")
                link_directories("/opt/homebrew/opt/llvm@9/lib")
            endif ()
        endif ()
    endif ()
endmacro()
